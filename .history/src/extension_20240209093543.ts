...
/* 2222222222  let disposableKeyListener = vscode.workspace.onDidChangeTextDocument(event => {
  ...
  event.contentChanges.forEach(change => {
    ...
    if (isInProgress === true && startLine !== null) {
      lineRange.push({
        startLine: startLine + 1, // Increment by 1 for 1-based indexing
        endLine: currentLine + 1, // Increment by 1 for 1-based indexing
        text: change.text,
      });
      isInProgress = false;
    }
